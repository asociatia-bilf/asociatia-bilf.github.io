(function(){
    var load_float_fb = function($){
        ...
        $("body").append(
            ...
            '<img src="'https://icon-library.com/images/small-facebook-like-icon/small-facebook-like-icon-25.jpg'" style="cursor:pointer;position:absolute;margin-left:-47px;" border=0 />',
